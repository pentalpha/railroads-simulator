...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Trem_t, stringdata) + ofs \
...
const QMetaObject Trem::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Trem.data,
      qt_meta_data_Trem,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Trem.stringdata))
